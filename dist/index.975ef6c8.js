...
function onBtnClick(event) {
    ...
    fetchCData(data).then(({ hits  })=>{
        if (!hits.length) {
            console.log(hits.length);
            (0, _notiflixReportAio.Report).failure("Unsuccessfully", false);
        }
        creatMarcUPGallery(hits);
        let gallery = new (0, _simplelightboxDefault.default)(".gallery a", {
            captionDelay: 250
        });
    }).catch((error)=>(0, _notiflixReportAio.Report).failure("ERROR", '"Sorry, there are no images matching your search query. Please try again" <br/><br/>', "Try againe"));
}
...
function fetchCData(data) {
    ...
    return fetch(`${API_BASE_URL}${endPoinds}`).then((resp)=>{
        if (!resp.ok) throw new Error((0, _notiflixReportAio.Report).failure("ERROR", '"Sorry, there are no images matching your search query. Please try again" <br/><br/>', "Try againe"));
        return resp.json();
    });
}
function creatMarcUPGallery(arr) {
    refs.btnLoadMore.hidden = false;
    return refs.gallary.innerHTML = arr.map((el)=>`
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5","notiflix/build/notiflix-report-aio":"hNopu"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hNopu":[function(require,module,exports) {
var global = arguments[3];
/*
